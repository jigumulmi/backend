...
import com.jigumulmi.place.dto.response.AdminCreatePlaceResponseDto;
import com.jigumulmi.place.dto.response.AdminPlaceBasicResponseDto;
import com.jigumulmi.place.dto.response.AdminPlaceBusinessHourResponseDto.TemporaryBusinessHourDto;
import com.jigumulmi.place.dto.response.AdminPlaceListResponseDto;
import com.jigumulmi.place.dto.response.AdminPlaceListResponseDto.PlaceDto;
import com.jigumulmi.place.dto.response.AdminS3DeletePresignedUrlResponseDto;
import com.jigumulmi.place.dto.response.AdminS3PutPresignedUrlResponseDto;
...
import com.jigumulmi.place.repository.AdminSubwayStationPlaceRepository;
...
public class AdminPlaceManager {
    ...
    private final AdminSubwayStationPlaceRepository adminSubwayStationPlaceRepository;
    ...
    public void updatePlaceBasic(Long placeId, AdminCreatePlaceRequestDto requestDto) {
        ...
        place.adminBasicUpdate(requestDto.getName(), requestDto.getRegion(),
            requestDto.getDistrict(), requestDto.getAddress(), requestDto.getContact(),
            requestDto.getAdditionalInfo(), requestDto.getPlaceUrl(),
            requestDto.getRegistrantComment(), requestDto.getKakaoPlaceId(),
    ...
    public void updateTemporaryBusinessHour(Long hourId,
        ...
        temporaryBusinessHour.adminUpdate(requestDto.getDate(), requestDto.getBusinessHour());
    }
